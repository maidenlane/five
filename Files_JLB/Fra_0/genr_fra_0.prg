...
'     indirect taxes are not separated into VAT and other taxes
'
scalar f_p_oit=0.2
...
'      Trade af current and constant prices, associated deflators
...
'      This separation is important as VAT will apply to final demand
...
scalar f_r_vat0=@elem(f_r_vat,"1995Q1")
...
'        Government consumption (includes wages of civl servants)
 
genr f_cog=fra_CGV 
genr f_cogv=fra_CGV*f_pfd
...
genr f_socbr = fra_TRRH /f_pc/f_pop
...
genr f_fcapgp=100*f_fcapg/f_gdpmval
...
genr f_fcapf=f_prof-f_pfd*f_i-f_pfd*f_ic    
