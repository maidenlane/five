...
FCAPF.label(u)  Euros
Fcapf_er.label(c)  
Fcapf_er.label(r)  _fcapf_er=(fcapf-(prof-pi*i-pfd*ci) ) /qval
Fcapf_er.label(d)  Residual on Firms financing capacity
Fcapf_er.label(u)  Ratio
FCAPG.label(c)  
...
IRLX.label(c)  
IRLX.label(r)   irlx=fra_irlaf
IRLX.label(d)  Interest rate, long run, exogenous value
IRLX.label(u)  Points
IRM.label(c)  
IRM.label(r)   irm=ir
...
IRM.label(u)  Points
IRM_ER.label(c)  
IRM_ER.label(r)  irm_er=irm-(p_irm*irm(-1) +(1-p_irm) *ir) 
IRM_ER.label(d)  interest rate, average on current debt, residual
IRM_ER.label(u)  Points
IRMX.label(c)  
...
OIT.label(u)  Euros
PCOG.label(c)  
PCOG.label(r)   pcog=fra_cg/fra_cgv
PCOG.label(d)  Deflator of Government consumption
PCOG.label(u)  Deflator, base 1995
PCOH.label(c)  
PCOH.label(r)   pcoh=fra_cp/fra_cpv
PCOH.label(d)  Deflator of household consumption
PCOH.label(u)  Deflator, base 1995
PFD.label(c)  
...
PL.label(u)  1995 Euros per person
PLT.label(c)  
PLT.label(r)  Estimated
PLT.label(d) Trend in labor productivity  
PLT.label(u)  1995 Euros per person
PM.label(c)  
...
PROF.label(u)  Euros
prof_er.label(c)  
prof_er.label(r)   prof_er=(prof-prof1) /qval
prof_er.label(d)  Residual on firms profits
prof_er.label(u)  Deflator, base 1995
PROF1.label(c)  
...
R_OIT.label(u)  Ratio
R_PCOG.label(c)  
R_PCOG.label(r)   r_pcog=pcog/pfd
R_PCOG.label(d)  Ratio of the government consumption price to the global demand deflator
R_PCOG.label(u)  Ratio
R_PCOH.label(c)  
R_PCOH.label(r)   r_pcoh=pcoh/pfd
R_PCOH.label(d)  Ratio of the household consumption price to the global demand deflator
R_PCOH.label(u)  Ratio
R_PI.label(c)  
